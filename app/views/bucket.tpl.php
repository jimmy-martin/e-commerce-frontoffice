<section class="hero">
      <div class="container">
        ...
        <div class="hero-content pb-5 text-center">
          ...
          <div class="row">   
            <div class="col-xl-8 offset-xl-2"><p class="lead text-muted">Vous avez <?= count($bucketProducts) ?> produits dans votre panier</p></div>
          </div>
        </div>
      </div>
    </section>
          ...
          <div class="col-lg-8">
            <div class="cart">
              <div class="cart-wrapper">
                ...
                <div class="cart-body">
                  <!-- Product-->
                  <?php foreach($bucketProducts as $product) :?>
                  <div class="cart-item">
                    <div class="row d-flex align-items-center text-center">
                      ...
                      <div class="col-2">
                        <div class="d-flex align-items-center">
                          ...
                          <input value="<?= $product->getQuantity() ?>" class="form-control text-center input-items" type="text">
                          <div class="btn btn-items btn-items-increase">+</div>
                        </div>
                      </div>
                      <div class="col-2 text-center"><?= $product->getTotal() ?>€</div>
            ...
            <div class="block mb-5">
              ...
              <div class="block-body bg-light pt-1">
                ...
                <ul class="order-summary mb-0 list-unstyled">
                  <li class="order-summary-item"><span>Sous total</span><span><?= $product->getPrice()*$product->getQuantity() ?>€</span></li>
                  <li class="order-summary-item"><span>Livraison</span><span>10€</span></li>
                  <li class="order-summary-item"><span>TVA</span><span>0€</span></li>
                  <li class="order-summary-item border-0"><span>Total</span><strong class="order-summary-total"><?= $product->getPrice()*$product->getQuantity() + 10 ?>€</strong></li>
                </ul>
              </div>
            </div>
          </div>
